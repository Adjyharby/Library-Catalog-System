...
--
-- Host: 127.0.0.1
-- Generation Time: Mar 07, 2025 at 01:37 PM
...
(4, 'Noel Salazar', 'Male', 21, 'N/A', '14:58:14', '00:00:00', '2025-03-02', 'N/A', 'Study'),
...
--
ALTER TABLE `admin`
  ADD CONSTRAINT `admin_ibfk_1` FOREIGN KEY (`AdminID`) REFERENCES `catalog` (`AdminID`);
COMMIT;
